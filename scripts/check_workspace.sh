...
echo "t23 project      : $REPO_ROOT/t23_rebuild"
echo "c3 project       : $REPO_ROOT/c3_rebuild"
echo "shared project   : $REPO_ROOT/t23_c3_shared"
echo "sdk dependency   : $REPO_ROOT/third_party/ingenic_t23_sdk"
echo "vendor reference : $REPO_ROOT/third_party/vendor_reference"
echo

for p in \
    "$REPO_ROOT/t23_rebuild" \
    "$REPO_ROOT/c3_rebuild" \
    "$REPO_ROOT/t23_c3_shared"; do
    if [ -d "$p" ]; then
        echo "[ok] found $p"
    else
        echo "[missing] $p"
