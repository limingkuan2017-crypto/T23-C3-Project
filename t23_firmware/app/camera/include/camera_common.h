 ...
 *
 * The firmware project keeps many vendor sensor definitions so the file remains
 ...
 *
 * In the firmware project snapshots are intentionally written to /tmp so JPEG
